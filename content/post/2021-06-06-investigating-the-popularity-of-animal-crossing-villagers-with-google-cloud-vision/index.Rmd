---
title: Investigating the Popularity of Animal Crossing Villagers with Google Cloud Vision
author: ~
date: '2021-06-06'
slug: investigating-the-popularity-of-animal-crossing-villagers-with-google-cloud-vision
tags:
    - r
...
There's an underlying question here that I don't have an immediate answer for --- is minimising the root mean squared error of `log(popularity)` the same as minimising the root mean squared error of `popularity`? I suspect the distinction isn't too important here.
