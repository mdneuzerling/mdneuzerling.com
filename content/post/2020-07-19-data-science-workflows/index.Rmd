...
![Tweet by mdneuzerling: (Python) How do you structure your projects when you know it’s going to be a complicated piece of work? Do you just start making notebooks, or do you carefully set up a module structure first? Do python projects have a “refactor notebooks to scripts” phase?](figs/tweet-1.png)
